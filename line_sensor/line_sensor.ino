...
void line_following(int line_index)
{
  switch(line_index)
  {
   case -4: motor_R_control(40);  motor_L_control(-80); // 왼쪽으로 아주 많이 회전
    break;
    case -3: motor_R_control(-5);  motor_L_control(-80); // 왼쪽으로 많이 회전
    break;
    case -2: motor_R_control(-35);  motor_L_control(-80); // 왼쪽으로 조금 회전
    break;
    case -1: motor_R_control(-60);  motor_L_control(-80); // 왼쪽으로 아주 조금 회전
    break;
    case  0: motor_R_control(-80);  motor_L_control(-100);
    break;
    case  1: motor_R_control(-140);  motor_L_control(-60); // 오른쪽으로 아주 조금 회전
    break;
    case  2: motor_R_control(-150);  motor_L_control(-60); // 오른쪽으로 조금 회전
    break;
    case  3: motor_R_control(-160);  motor_L_control(50); // 오른쪽으로 많이 회전
    break;
    case  4: motor_R_control(-170);  motor_L_control(40); // 오른쪽으로 아주 많이 회전
    break;
