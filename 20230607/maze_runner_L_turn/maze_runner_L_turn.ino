...
void line_following(int line_index)
{
  switch(line_index)
  {
    case -4: motor_L_control(100);  motor_R_control(-40); 
    break;
    case -3: motor_L_control(100);  motor_R_control(10);
    break;
    case -2: motor_L_control(80);  motor_R_control(30);
    break;
    case -1: motor_L_control(100);  motor_R_control(70);
    break;
    case  0: motor_L_control(100);  motor_R_control(100);
    break;
    case  1: motor_L_control(80);  motor_R_control(110);
    break;
    case  2: motor_L_control(100);  motor_R_control(60);
    break;
    case  3: motor_L_control(50);  motor_R_control(110);
    break;
    case  4: motor_L_control(-40);  motor_R_control(200);
    break;
 ...
 void loop()
{
  ...
  if(mission_flag[0] == 0){ // line tracing
    ...
    if(front_sonar < 200)
    {
      ...
      delay(1000);
      motor_L_control(1500);  motor_R_control(-150);
      delay(400);
      motor_L_control(40);  motor_R_control(200);
      delay(2000);
      mission_flag[0] = 2; 
      mission_flag[2] = 0;
    }
