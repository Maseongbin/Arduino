...
void line_following(int line_index)
{
  switch(line_index)
  {
    ...
    break;
    case -2: motor_L_control(80);  motor_R_control(35);
    break;
    case -1: motor_L_control(80);  motor_R_control(60);
    break;
    case  0: motor_L_control(80);  motor_R_control(80);
    break;
    case  1: motor_L_control(85);  motor_R_control(100);
    break;
    case  2: motor_L_control(100);  motor_R_control(70);
    break;
    case  3: motor_L_control(60);  motor_R_control(100);
    break;
    case  4: motor_L_control(-40);  motor_R_control(170);
    break;
